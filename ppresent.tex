...
\begin{frame}{Galois Groups}
  ...
  but there are no general rules to compute it for the polynomials of degree 5 or above \cite{hunger}.
  \vspace{10mm}
...
\begin{example}[Examples]
  \begin{align*}
    GF(2) &= \{0,1\} \hspace{3mm} \textcolor{green!50!black}{(Binary \;\; Fields)}\\
...
\vspace{3mm}
  ...
  \begin{figure}[h]
    ...
    \centering
    \begin{tikzpicture}
      \draw [ultra thick, outer color=blue!40, inner color= green!80] (0,0) circle [radius=1.3];
      \draw[thick, fill=gray] (0,0) circle [radius=0.4];
      \draw[thick, fill=white] (0,0) circle [radius=0.2];
    \end{tikzpicture}
